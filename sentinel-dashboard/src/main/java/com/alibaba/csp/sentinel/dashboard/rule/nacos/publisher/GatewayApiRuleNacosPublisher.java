 ...
 */
@Component
public class GatewayApiRuleNacosPublisher extends AbstractRuleNacosPublisher<ApiDefinitionEntity> {
    ...
    @Override
    public Converter<List<ApiDefinitionEntity>, String> getRuleEntityEncoder() {
